 ...
 * to open the database read/write. I don't think this will ever happen in ClientCollection, though. (fingers
 * crossed).
 */
 ...
 * </p>
 */
public abstract class ClientCollectionSQLiteOpenHelper {
    private static final String t = ClientCollectionSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public ClientCollectionSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
