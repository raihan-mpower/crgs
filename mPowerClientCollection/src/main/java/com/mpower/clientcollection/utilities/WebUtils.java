...
public final class WebUtils {
	...
	public static final void clearAllCredentials() {
		CredentialsProvider credsProvider = ClientCollection.getInstance()
	...
	public static final void setGoogleHeaders(HttpRequest req) {
		SharedPreferences settings =
                PreferenceManager.getDefaultSharedPreferences(ClientCollection.getInstance().getApplicationContext());
		String protocol = settings.getString(PreferencesActivity.KEY_PROTOCOL, PreferencesActivity.PROTOCOL_CLIENT_COLLECTION_DEFAULT);
	...
	public static final synchronized HttpClient createHttpClient(int timeout) {
		...
		// reuse the connection manager across all clients this mintel 
		// creates.
	...
	public static final String getHttpPostResponse(HttpResponse response) {
		String content = null;
