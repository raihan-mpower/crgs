    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!WebUtils.hasCredentials()){
        	...
        	if(username != null && password != null){
        		...
        		Toast.makeText(InstanceUploaderActivity.this, "You are not logged in or not use username and password", Toast.LENGTH_SHORT).show();
        ...
        switch (id) {
                ...
                DialogInterface.OnClickListener loadingButtonListener =
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                        	ClientCollection.getInstance().getActivityLogger().logAction(this, "onCreateDialog.PROGRESS_DIALOG", "cancel");
                            dialog.dismiss();
            ...
            case AUTH_DIALOG:
                ...
                if (server == null) {
                    ...
                    String submissionUrl = getString(R.string.default_clientcollection_submission);
                    server =
