...
public class FormManagerList extends ListActivity implements DiskSyncListener,
	...
	private void createDeleteFormsDialog() {
    	ClientCollection.getInstance().getActivityLogger().logAction(this, "createDeleteFormsDialog", "show");
		...
		DialogInterface.OnClickListener dialogYesNoListener = new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int i) {
				...
				case DialogInterface.BUTTON_POSITIVE: // delete
			    	ClientCollection.getInstance().getActivityLogger().logAction(this, "createDeleteFormsDialog", "delete");
					deleteSelectedForms();
					break;
				case DialogInterface. BUTTON_NEGATIVE: // do nothing
			    	ClientCollection.getInstance().getActivityLogger().logAction(this, "createDeleteFormsDialog", "cancel");
					break;
				}
			}
		};
