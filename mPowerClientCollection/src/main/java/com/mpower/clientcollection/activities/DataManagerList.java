...
public class DataManagerList extends ListActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDeleteButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		    	ClientCollection.getInstance().getActivityLogger().logAction(this, "deleteButton", Integer.toString(mSelected.size()));
				if (mSelected.size() > 0) {
	...
	private void createDeleteInstancesDialog() {
        ClientCollection.getInstance().getActivityLogger().logAction(this, "createDeleteInstancesDialog", "show");
		...
		DialogInterface.OnClickListener dialogYesNoListener = new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int i) {
				...
				case DialogInterface.BUTTON_POSITIVE: // delete
			    	ClientCollection.getInstance().getActivityLogger().logAction(this, "createDeleteInstancesDialog", "delete");
					deleteSelectedInstances();
					break;
				case DialogInterface. BUTTON_NEGATIVE: // do nothing
			    	ClientCollection.getInstance().getActivityLogger().logAction(this, "createDeleteInstancesDialog", "cancel");
					break;
				}
			}
		};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		ClientCollection.getInstance().getActivityLogger().logAction(this, "onListItemClick", Long.toString(k));
	...
	public void deleteComplete(int deletedInstances) {
        ...
        ClientCollection.getInstance().getActivityLogger().logAction(this, "deleteComplete", Integer.toString(deletedInstances));
