...
import com.mpower.clientcollection.utilities.ColorPickerDialog;
...
public class DrawActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras == null) {
			...
			refImage = null;
			savepointImage = new File(FormsDirectory.TMPDRAWFILE_PATH);
			savepointImage.delete();
			output = new File(FormsDirectory.TMPFILE_PATH);
		} else {
	...
	public class DrawView extends View {
		...
		public DrawView(final Context c) {
			...
			mBackgroundBitmapFile = new File(FormsDirectory.TMPDRAWFILE_PATH);
		}
