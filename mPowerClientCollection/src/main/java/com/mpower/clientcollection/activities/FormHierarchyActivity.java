...
import com.mpower.clientcollection.adapters.HierarchyListAdapter;
import com.mpower.clientcollection.application.ClientCollection;
import com.mpower.clientcollection.logic.FormController;
import com.mpower.clientcollection.logic.HierarchyElement;
...
public class FormHierarchyActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        jumpPreviousButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "goUpLevelButton", "click");
                goUpLevel();
            }
        });
        ...
        jumpBeginningButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "jumpToBeginning", "click");
                ClientCollection.getInstance().getFormController().jumpToIndex(FormIndex
    ...
    private void goUpLevel() {
    	ClientCollection.getInstance().getFormController().stepToOuterScreenEvent();
        refreshView();
    }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (h.getType()) {
            case EXPANDED:
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "onListItemClick", "COLLAPSED", h.getFormIndex());
                h.setType(COLLAPSED);
                ...
                break;
            case COLLAPSED:
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "onListItemClick", "EXPANDED", h.getFormIndex());
                h.setType(EXPANDED);
                ...
                break;
            case QUESTION:
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "onListItemClick", "QUESTION-JUMP", index);
                ClientCollection.getInstance().getFormController().jumpToIndex(index);
            	if ( ClientCollection.getInstance().getFormController().indexIsInFieldList() ) {
            		ClientCollection.getInstance().getFormController().stepToPreviousScreenEvent();
            	}
                setResult(RESULT_OK);
                finish();
                return;
            case CHILD:
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "onListItemClick", "REPEAT-JUMP", h.getFormIndex());
                ClientCollection.getInstance().getFormController().jumpToIndex(h.getFormIndex());
                setResult(RESULT_OK);
                refreshView();
                return;
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "onKeyDown", "KEYCODE_BACK.JUMP", mStartIndex);
                ClientCollection.getInstance().getFormController().jumpToIndex(mStartIndex);
        }
