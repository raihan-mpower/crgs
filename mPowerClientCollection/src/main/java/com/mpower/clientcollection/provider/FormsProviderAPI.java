...
public final class FormsProviderAPI {
	 ...
	 //public static final String AUTHORITY = ClientCollection.getAppContext().getString(R.string.form_provider_authority);
	public static final String AUTHORITY = ClientCollection.FORM_AUTHORITY_NAME;
    ...
    public static final class FormsColumns implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.clientcollection.form";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.clientcollection.form";
