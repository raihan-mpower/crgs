...
public class AlignedImageWidget extends QuestionWidget implements IBinaryWidget {
    private static final String ClientCollection_CAMERA_TAKE_PICTURE_INTENT_COMPONENT = "com.mpower.ClientCollection.android.camera.TakePicture";

	private static final String ClientCollection_CAMERA_INTENT_PACKAGE = "com.mpower.ClientCollection.android.camera";
    ...
    public AlignedImageWidget(Context context, FormEntryPrompt prompt) {
        ...
        mInstanceFolder =
                ClientCollection.getInstance().getFormController().getInstancePath().getParent();
        ...
        mCaptureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               	ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "captureButton",
            			"click", mPrompt.getIndex());
                mErrorTextView.setVisibility(View.GONE);

                Intent i = new Intent();
                i.setComponent(new ComponentName(ClientCollection_CAMERA_INTENT_PACKAGE,
                					ClientCollection_CAMERA_TAKE_PICTURE_INTENT_COMPONENT));
                i.putExtra(FILE_PATH_EXTRA, FormsDirectory.CACHE_PATH);
                ...
                try {
                	ClientCollection.getInstance().getFormController().setIndexWaitingForData(mPrompt.getIndex());
        ...
        mChooseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               	ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "chooseButton",
            			"click", mPrompt.getIndex());
                mErrorTextView.setVisibility(View.GONE);
        ...
        if (mBinaryName != null) {
            ...
            mImageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                   	ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "viewButton",
                			"click", mPrompt.getIndex());
    ...
    public boolean isWaitingForBinaryData() {
    	return mPrompt.getIndex().equals(ClientCollection.getInstance().getFormController().getIndexWaitingForData());
    }
