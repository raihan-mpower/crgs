...
/**
 * <p>Use the ClientCollection Sensors framework to print data to a connected printer.</p>
 *
 ...
 *
 * <p>The ClientCollection Sensors Zebra printer uses this appearance (intent):</p>
 * <pre>
 ...
 *            &lt;value form="noPrinterErrorString"&gt;ClientCollection Sensors Zebra Printer is not installed!
 *             Please install mintel Sensors Framework and mintel Sensors Zebra Printer from Google Play.&lt;/value&gt;
 *          &lt;/text&gt;
 *        &lt;/translation&gt;
 *      &lt;/itext&gt;
 *    ...
...
public class ExPrinterWidget extends QuestionWidget implements IBinaryWidget {
    ...
    protected void firePrintingActivity(String intentName) throws ActivityNotFoundException {
        ...
        String s = mPrompt.getAnswerText();
       	...
       	ClientCollection.getInstance().getActivityLogger().logInstanceAction(this, "launchPrinter",
